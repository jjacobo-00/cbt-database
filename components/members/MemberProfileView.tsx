...
export function MemberProfileView({
  ...
  const permAddressParts = [
    ...
    member.perm_country && member.perm_country !== "Philippines"
      ? member.perm_country
      : null,
  ].filter(Boolean);
  ...
  const handlePrint = () => {
    ...
    document.title =
      `${member.last_name || ""} ${member.first_name || ""} ${dateStr}`.trim();
    window.print();
    setTimeout(() => {
    ...
    <div className="space-y-6 animate-in fade-in duration-300 w-full min-w-0 max-w-full">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-in fade-in duration-200">
          <div className="bg-card border rounded-xl p-6 max-w-md w-full shadow-2xl space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              ? This action will permanently remove their profile and all
              associated commitment history.
            </p>
                  ...
                  {member.church_role && member.church_role !== "Member" && (
                    <span
                      className={cn(
                        ...
                        member.church_role === "Main Pastor" &&
              ...
              <div className="w-full sm:w-auto bg-amber-500/10 border border-amber-500/20 rounded-xl p-3 flex items-center gap-3 text-xs">
                ...
                <div>
                  ...
                  <span className="text-muted-foreground">
                    ...
                    {member.emergency_contact_relationship || "Relation"}):{" "}
                  </span>
                  <a
              ...
              <span className="break-all whitespace-normal leading-tight text-foreground font-medium">
                {member.contact_number ? (
                  <a
                    ...
                    className="hover:underline text-foreground font-medium break-all whitespace-normal"
                  >
                    {member.contact_number}
                  </a>
                ) : (
      ...
      <div className="flex border-b overflow-x-auto scrollbar-none gap-2 sm:gap-6 print:hidden w-full max-w-full">
        {[
          ...
          {
            id: "commitments",
            label: `Commitments (${commitmentsHistory.length})`,
            icon: Gift,
          },
        ].map((tab) => {
          const Icon = tab.icon;
        ...
        <div className="space-y-6 print:hidden">
          <div className="grid gap-6 md:grid-cols-2 items-start">
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base flex items-center gap-2">
                    <Church className="h-5 w-5 text-primary" /> Active
                    Ministries
                  </CardTitle>
            ...
            <Card className="shadow-sm border-amber-500/30 bg-amber-500/5">
              ...
              <CardContent className="space-y-4 text-sm">
                ...
                <div className="space-y-2">
                  <h4 className="text-[10px] font-bold uppercase tracking-wider text-amber-600/70 border-b border-amber-500/20 pb-1 mb-2">
                    Emergency Contact
                  </h4>
                  ...
                  <div className="flex justify-between gap-4">
                    ...
                    {member.emergency_contact_number ? (
                      <a
                        href={`tel:${member.emergency_contact_number}`}
                        className="font-bold text-primary hover:underline text-right break-all whitespace-normal min-w-0"
                      >
                        {member.emergency_contact_number}
                      </a>
                    ) : (
                ...
                <div className="space-y-2 pt-2 border-t border-amber-500/20">
                  ...
                  <div className="flex justify-between gap-4">
                    ...
                    <span className="font-semibold text-right break-words whitespace-normal min-w-0 text-red-600 dark:text-red-400">
            ...
            <Card className="shadow-sm">
              <CardHeader className="pb-3">
                <CardTitle className="text-base flex items-center gap-2">
                  <Sparkles className="h-5 w-5 text-primary" /> Spiritual
                  Milestone Summary
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-sm">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {member.date_baptized || member.baptism_date || "—"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="col-span-2 pt-2 border-t flex items-center justify-between">
                    ...
                    <span className="font-bold text-sm text-primary bg-primary/10 px-2.5 py-0.5 rounded-full border border-primary/20">
                      {(() => {
                        ...
                        return member.years_in_church !== null &&
                          member.years_in_church !== undefined
                          ? `${member.years_in_church} years`
                          : "0 years";
                      })()}
                    </span>
                  </div>
      ...
      {(activeTab === "personal" || false) && (
        <Card className="shadow-sm print:hidden">
          <CardHeader>
            ...
            <CardDescription>
              Comprehensive identification and location information
            </CardDescription>
          </CardHeader>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="font-medium break-all whitespace-normal leading-tight">
                    {member.email || "—"}
                  </span>
                </div>
              </div>
                ...
                {member.is_perm_same_as_current ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="font-medium">
                        {member.perm_country || "Philippines"}
                      </span>
                    </div>
                  </div>
                )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm bg-muted/10 p-4 rounded-xl border border-muted/50">
                ...
                <div>
                  ...
                  <span className="font-medium">
                    {member.allergies || "None declared"}
                  </span>
                </div>
                <div>
                  <span className="text-muted-foreground block text-xs">
                  ...
                  <span className="font-medium">
                    {member.medical_conditions || "None declared"}
                  </span>
                </div>
              </div>
            </div>
                    ...
                    <p>
                      ...
                      <span className="font-medium">
                        {member.father_member_id ? (
                          <Link
                            href={`/members/${member.father_member_id}`}
                    ...
                    <p>
                      ...
                      <span className="font-medium">
                        {member.mother_member_id ? (
                          <Link
                            href={`/members/${member.mother_member_id}`}
                            className="text-primary hover:underline"
                          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
                  ...
                  <span className="font-medium">
                    {member.spouse_name ? (
                      member.spouse_member_id ? (
                        <Link
                          href={`/members/${member.spouse_member_id}`}
                          className="text-primary hover:underline"
                        >
                ...
                <div className="bg-muted/10 p-4 rounded-xl border border-border/50">
                  ...
                  <span className="font-medium">
                    {member.anniversary_date ? (
                      !isNaN(
                        new Date(member.anniversary_date).getFullYear(),
                      ) ? (
                    ...
                    {childrenList.map((c) => (
                      ...
                      >
                        <span className="font-medium">
                          {c.child_member_id ? (
                            <Link
                              href={`/members/${c.child_member_id}`}
                              className="text-primary hover:underline"
                            >
                              {c.name} (Member)
                            </Link>
                    ...
                    {siblings.map((s, idx) => (
                      ...
                      >
                        <span className="font-medium">
                          {s.sibling_member_id ? (
                            <Link
                              href={`/members/${s.sibling_member_id}`}
                              className="text-primary hover:underline"
                            >
                              {s.name} (Member)
                            </Link>
        ...
        <div className="space-y-6 print:hidden">
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg flex items-center gap-2">
                  <GraduationCap className="h-5 w-5 text-primary" /> Educational
                  Background History
                </CardTitle>
            ...
            <CardContent className="space-y-4">
              {educationDetails.length === 0 ? (
                <p className="text-sm text-muted-foreground italic">
                  No detailed education history records.
                </p>
              ) : (
                <div className="space-y-3">
                  {educationDetails.map((edu, idx) => (
                    <div
                      key={idx}
                      className="p-4 rounded-xl border bg-card shadow-2xs space-y-1 text-sm"
                    >
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        {edu.is_currently_enrolled ? (
                          ...
                          <span className="text-xs text-muted-foreground">
                            {edu.year_started
                              ? `${edu.year_started} - ${edu.year_graduated || "Present"}`
                              : ""}
                          </span>
                        )}
                      </div>
              ...
              {member.awards_honors && (
                <div className="pt-4 border-t space-y-1">
                  <h5 className="font-semibold text-xs text-muted-foreground flex items-center gap-1.5">
                    <Award className="h-4 w-4 text-amber-500" /> Academic Awards
                    & Honors
                  </h5>
      ...
      {(activeTab === "spiritual" || false) && (
        <Card className="shadow-sm print:hidden">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              <Church className="h-5 w-5 text-primary" /> Church & Spiritual
              Information
            </CardTitle>
            <CardDescription>
              Baptism, salvation, and local church membership details
            </CardDescription>
          </CardHeader>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <span className="font-medium">
                    {member.witnessed_by || member.witness_by || "—"}
                  </span>
                </div>
              </div>
            </div>
      ...
      {(activeTab === "commitments" || false) && (
        <Card className="shadow-sm print:hidden">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              <Gift className="h-5 w-5 text-primary" /> Yearly Recommitment &
              Offering History
            </CardTitle>
            <CardDescription>
              Record of annual ministry commitments and offering category
              pledges
            </CardDescription>
          </CardHeader>
          <CardContent>
            {commitmentsHistory.length === 0 ? (
              ...
              <div className="space-y-6">
                {commitmentsHistory.map((item) => (
                  <div
                    key={item.year}
                    className="p-4 rounded-xl border bg-card shadow-2xs space-y-3"
                  >
                    <div className="flex items-center justify-between border-b pb-2">
                      <span className="font-bold text-lg text-primary">
                        {item.year} Commitment
                      </span>
                        ...
                        {item.offerings.length === 0 ? (
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {item.offerings.map((oName, idx) => (
                              <span
                                key={idx}
                                className="text-xs bg-amber-500/10 text-amber-600 dark:text-amber-400 px-2.5 py-1 rounded-md font-medium"
                              >
                                🎁 {oName}
                              </span>
                            ))}
      ...
      <div className="hidden print:block text-slate-900 bg-white w-full font-sans max-w-4xl mx-auto print:p-8 print:pt-4">
        ...
        <div className="border border-slate-300 rounded-lg text-sm shadow-sm">
          ...
          {(member.marital_status === "Married" ||
            member.marital_status === "Widow" ||
            member.marital_status === "Widower") && (
            <div className="grid grid-cols-3 divide-x divide-slate-300 border-b border-slate-300 bg-slate-50/50">
              ...
              <div className="p-2">
                ...
                <span className="font-semibold text-black">
                  {member.anniversary_date
                    ? new Date(member.anniversary_date).toLocaleDateString(
                        "en-US",
          ...
          {(member.marital_status === "Widow" ||
            ...
            <div className="p-2 border-b border-slate-300 bg-slate-50/50">
              ...
              <span className="font-semibold text-black">
                {member.widowed_date
                  ? new Date(member.widowed_date).toLocaleDateString("en-US", {
                      year: "numeric",
                      month: "short",
                      day: "numeric",
                    })
          ...
          <div className="grid grid-cols-2 divide-x divide-slate-300 border-b border-slate-300 break-inside-avoid">
            ...
            <div className="p-2">
              ...
              <span className="font-semibold text-black">
                ...
                member.employment_status === "Self-employed" ||
                member.company ||
                member.occupation
                  ? [member.occupation || member.position, member.company]
                      .filter(Boolean)
                      .join(" at ") ||
                    member.employment_status ||
                    "—"
          ...
          <div className="grid grid-cols-3 divide-x divide-slate-300 border-b border-slate-300 break-inside-avoid">
            <div className="p-2 min-w-0">
              ...
              <span className="font-semibold text-black break-words">
                {member.date_saved
                  ? new Date(member.date_saved).toLocaleDateString("en-US", {
                      year: "numeric",
                      month: "short",
                      day: "numeric",
                    })
          ...
          <div className="grid grid-cols-3 divide-x divide-slate-300 border-b border-slate-300 break-inside-avoid">
            ...
            <div className="p-2 min-w-0">
              ...
              <span className="font-semibold text-black break-words">
                {member.witness_by || member.witnessed_by || "—"}
              </span>
            </div>
          </div>
          ...
          <div className="p-2 break-inside-avoid">
            <span className="block text-[10px] uppercase font-semibold text-slate-500 mb-0.5">
              Currently Enrolled Ministries ({ministriesList.length})
            </span>
            <span className="font-semibold text-black break-words">
              {ministriesList.map((m) => m.name).join(", ") || "None"}
            </span>
          </div>
          ...
          <div className="break-inside-avoid">
            ...
            <table className="w-full text-left border-t border-slate-300">
              <thead className="bg-slate-50 text-[10px] uppercase text-slate-500 border-b border-slate-300">
                <tr>
                  <th className="p-2 border-r border-slate-300 font-semibold w-16">
                    Year
                  </th>
              ...
              <tbody className="divide-y divide-slate-300">
                {commitmentsHistory.length > 0 ? (
                  commitmentsHistory.map((c) => (
                    <tr key={c.year}>
                      <td className="p-2 border-r border-slate-300 font-bold text-black">
                        {c.year}
                      </td>
                      <td className="p-2 font-semibold text-black text-sm">
                        {c.ministries.join(", ") || "—"}
                      </td>
                    </tr>
                  ))
                  ...
                  <tr>
                    <td
                      colSpan={2}
                      className="p-2 italic font-semibold text-slate-400 text-center text-sm border-t-0"
                    >
